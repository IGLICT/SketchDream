...
@threestudio.register("sketch-dream-generation")
class SketchDreamGenSystem(BaseLift3DSystem):
    @dataclass
    ...
    def training_step(self, batch, batch_idx):
        ...
        if is_2D_loss:
            ...
            batch['global_step'] = self.true_global_step
        ...
        if self.C(self.cfg.loss.lambda_mask) > 0 and batch['mask'] is not None:
            ...
            loss_mask = F.mse_loss(batch["mask"].float(), opacity) * self.C(self.cfg.loss.lambda_mask)
