    ...
    def forward_local(
        ...
        **kwargs
        ...
        def sigma_fn(t_starts, t_ends, ray_indices):
            ...
            # distances, face_id, uvw = cubvh.signed_distance(positions, return_uvw=True, mode='raystab') # [N], [N], [N, 3]
            # index = distances > 0
        ...
        distances, face_id, uvw = cubvh.signed_distance(positions, return_uvw=True, mode='raystab') # [N], [N], [N, 3]
        # index = distances < 0
        index = distances < 0.03
        positions = positions[index]
        t_dirs = t_dirs[index]
        t_origins = t_origins[index]
        t_light_positions = t_light_positions[index]
        t_starts = t_starts[index]
        t_ends = t_ends[index]
        ray_indices = ray_indices[index]
        t_positions = t_positions[index]
